...
# Recovery
TBOARD_HAS_LARGE_FILESYSTEM := true
...
# Fixes the build error by telling the system to build the vendor_boot image
...
# Init
#TARGET_INIT_VENDOR_LIB         := libinit_CLA6
#TARGET_RECOVERY_DEVICE_MODULES := libinit_CLA6
